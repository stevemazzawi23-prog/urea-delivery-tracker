...
## Equipment Synchronization v2
- [x] Add equipment and clientEquipment tables to Drizzle schema
- [x] Create equipment tRPC router with CRUD endpoints
- [x] Add equipment API functions to api-client.ts
- [x] Update storage.ts getEquipment() to sync via API
- [x] Update storage.ts addEquipment() to sync via API
- [x] Update storage.ts deleteEquipment() to sync via API
- [x] Update storage.ts updateClientEquipment() to sync via API
